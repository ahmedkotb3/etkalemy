            ...
            <div class="row dropdown">
                <a id="dLabel" role="button" data-toggle="dropdown" class="btn drop" data-target="#" href="#"
                   style="outline: 0!important;">
                    ...
                    <button class="btn btn-success" id="btncaret1"><span class="caret"></span></button>
                </a>
                </a>
            </div>
        </div>
    ...
    <div class="container-fluid" style=" padding: 0; background-color: #D5E4E8; color: #376773">
        <div class="container-fluid" id="marginmobile">
            ...
            <div class="row"
                ...
                <div style="font-size:25px; font-family:ebold;">
                ...
                <div class="row">
                    <div class=" col-xs-6 col-sm-4 col-md-4 col-lg-5 pull-right"
                         style="    text-align: left;padding-left: 64px;">
                        <a href=""><img src="images/pictures/tagmoevent/facebook.png"></a>
                        <a href=""><img src="images/pictures/tagmoevent/twitter.png"></a></div>
                    <div class=" col-xs-3 col-sm-4 col-md-4 col-lg-2 pull-right"
                         style="text-align: center;border-left: 1px solid #BECBCF; border-right: 1px solid #BECBCF;">
                        <a href="#"><img src="images/pictures/tagmoevent/pdf.png"></a></div>
                    <div class=" col-xs-3 col-sm-4 col-md-4 col-lg-5" style="padding-right: 67px;"><a href="#"><img
                                    src="images/pictures/tagmoevent/calender.png"></a></div>
                </div>
                <div class="row">
                    <div class=" col-xs-6 col-sm-4 col-md-4 col-lg-5 pull-right">
                        <span class="pull-left" style="font-size: 15px; font-family:ebold;padding-left: 64px;">  لمتابعة الايفينت </span>
                    </div>
                    <div class=" col-xs-3 col-sm-4 col-md-4 col-lg-2 pull-right"
                         style=" text-align:center; border-left: 1px solid #BECBCF; border-right: 1px solid #BECBCF;">
                        <span style="font-size: 15px; font-family:ebold;"> برنامج اليوم  </span></div>
                    <div class=" col-xs-3 col-sm-4 col-md-4 col-lg-5"><span
                                style="font-size: 15px; font-family:ebold; padding-right: 41px;"> برنامج اليوم </span>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="imgWrap img-responsive" style=" height:595px!important;width: 100%!important;">
                ...
                <a href="#">
                    <button style="font-size: 42px; font-family: ebold; height: 75px;width: 390px; background-color: #78C8AB;border-color: #78C8AB;position: relative;
    top: -178px; right: -149px;" class="btn btn-primary"> و شاركى معانا الان
                    </button>
                </a>
            </div>
        </div>
        ...
        <div class="container-fluid" id="marginmobile">
            <div class="row" id="ronew">
                ...
                <hr class="col-xs-8 col-sm-7 col-md-8 col-lg-9" id="hrte">
            </div>
            <div class="container-fluid" style="background-color: white; padding: 10px;">
            ...
            <div class="row" id="ronew">
                ...
                <hr class="col-xs-5 col-sm-7 col-md-8 col-lg-9" id="hrte" style="margin-right: -31px;!important">
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 pull-right" id="rightdiv">
                    ...
                    <div class="row" style=" background-color: white; padding-left:80px; padding-right: 30px;">
            ...
            <div class="container-fluid" style="height:780px;background-color: white; padding: 10px;"></div>
