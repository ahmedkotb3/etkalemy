 ...
 <form class="form-horizontal" role="form" id="jous">
     <div class="form-group" style="padding-top:22px; ">
         ...
         <div class="col-sm-9" style=" height: 23px">
             <input type="text" class="form-control" id="namee" style="background-color: #D5E4E8;" name="english_name">
         </div>
     </div>
     <div class="form-group">
         ...
         <div class="col-sm-9" style=" height: 23px">
             <input type="text" class="form-control" id="namea" style="background-color: #D5E4E8;" name="arabic_name">
         </div>
     </div>
     <div class="form-group">
         ...
         <div class="col-sm-9" style=" height: 23px">
             <input type="email" class="form-control" id="email" style="background-color: #D5E4E8;" name="email">
         </div>
     </div>
     <div class="form-group">
         ...
         <div class="col-sm-9" style=" height: 23px">
             <input type="password" class="form-control" id="pass" style="background-color: #D5E4E8;" name="password">
         </div>
     </div>
     <div class="form-group">
         ...
         <div class="col-sm-9" style=" height: 23px">
             <input type="password" class="form-control" id="repass" style="background-color: #D5E4E8;" name="re_password">
         </div>
     </div>
    ...
    border-radius: 4px;" class="form-controlinput-medium bfh-countries" data-country="EG" name="country"></select>
         </div>
         ...
         <div class=" col-sm-3" style="height: 23px">
             <input type="text" class="form-control " id="city" style="background-color: #D5E4E8;" name="city">
             </div>
    ...
    border-radius: 4px;" class="form-controlinput-medium bfh-countries" data-country="EG"></select>
     ...
     <div class="form-group">
         ...
         <div class="col-sm-9" style="height: 23px">
             <input type="text" class="form-control" id="work" style="background-color: #D5E4E8;" name="work">
         </div>
     </div>
     <div class="form-group" style=" padding-bottom:22px;">
         ...
         <div class="col-sm-9" style="height: 23px">
             <input type="datetime" class="form-control" id="date" style="background-color: #D5E4E8;" name="date">
         </div>
     </div>
 </form>
        <div class="row" style="margin-left: 55px!important; margin-bottom: 150px!important;">
            <div class="col-sm-offset-3">
        {{--<button class="btn btn-info" style=" font-family:Cent; font-size: 20px; height: 40px; background-color:#78c8ab; border-radius:3px;" type="submit">Submit</button>--}}
        <input class="btn btn-info" style=" font-family:Cent; font-size: 20px; height: 40px; background-color:#78c8ab; border-radius:3px;" type="submit" value="Submit">
            </div></div>
    </div>
